...
class CustomVisionTransformer(VisionTransformer):
    def __init__(self, img_size=224, patch_size=16, *args, **kwargs):
        ...
        self.height, self.width = img_size  # type: ignore
...
def get_encoder(args):
    backbone = ResNetV2(
        ...
        preact=False, stem_type='same', conv_layer=StdConv2dSame)  # type: ignore
    ...
    encoder = CustomVisionTransformer(img_size=(args.max_height, args.max_width), # type: ignore
